...
redirects:
  - /bagels
description: "This Frankenstein's recipe is centered on combining the lovely flavor of a good everything bagel with a sourdough tang and a bit of natural sweetness from whole wheat flour."
---
...
<FoodContextProvider>
  ...
  **CAUTION!** You could exclude the everything seasoning described here and still have a tasty bagel. However, please be careful replacing the mix described here with a pre-mixed/store-bought seasoning; there's a good chance it has additional salt in it that would through the dough out of balance, ruining the bagels.
  ...
  <div className='systemSwitchers'>
    <SystemSwitcher scale='mass' legend='Weight Scale' />
    <SystemSwitcher scale='temps' legend='Temperature Scale' />
  </div>
  ...
  <IngredientList
    ingredients={[
      { scale: 'mass', value: 300, unit: 'g', description: 'active 100% hydration sourdough starter' },
      { scale: 'mass', value: 475, unit: 'g', description: 'cold water' },
      { scale: 'mass', value: 20, unit: 'g', description: 'malt syrup or molasses' },
      { scale: 'mass', value: 1000, unit: 'g', description: 'all-purpose flour' },
      { scale: 'mass', value: 125, unit: 'g', description: 'whole wheat flour' },
      { scale: 'mass', value: 15, unit: 'g', description: 'salt' },
      {
        scale: 'mass',
        value: 5,
        unit: 'g',
        description: 'whole-grain bread improver (optional)',
        href: 'https://shop.kingarthurbaking.com/items/whole-grain-bread-improver-12-oz'
      },
    ]}
  />
  ...
  <IngredientList
    ingredients={[
      { scale: 'mass', value: 20, unit: 'g', description: 'white sesame seeds' },
      { scale: 'mass', value: 20, unit: 'g', description: 'black sesame seeds' },
      { scale: 'mass', value: 25, unit: 'g', description: 'dried minced garlic' },
      { scale: 'mass', value: 15, unit: 'g', description: 'dried minced onion' },
      { scale: 'mass', value: 10, unit: 'g', description: 'poppy seeds' },
    ]}
  />
  ...
  **<Ingredient scale='mass' value={300} unit='g' description='starter' />**,
  **<Ingredient scale='mass' value={475} unit='g' description='water' />**, and
  **<Ingredient scale='mass' value={20} unit='g' description='malt syrup' />** until frothy.
  1. Add flours and seasonings:
      - **<Ingredient scale='mass' value={125} unit='g' description='whole wheat flour' />**
      - **<Ingredient scale='mass' value={5} unit='g' description='whole-grain bread improver' />** (optional)
      - **<Ingredient scale='mass' value={1000} unit='g' description='all purpose flour' />**
      - **<Ingredient scale='mass' value={15} unit='g' description='salt' />**
  ...
  ---
  1. Divide into 12 equal pieces (**~<Ingredient scale='mass' value={167} unit='g' description='each' />**), shape each into ball. Cover and **rest 15 minutes**.
  ...
  ## Day 2
  1. Preheat oven to **<Ingredient scale='temps' value={450} unit='°F' />**.
  ...
  ---
  1. Put bagels in the center of oven and reduce temperatures to **<Ingredient scale='temps' value={400} unit='°F' />**.
  2. Bake for **18-22 minutes**, until golden on top or internal temp registers at least **<Ingredient scale='temps' value={190} unit='°F' />**.
